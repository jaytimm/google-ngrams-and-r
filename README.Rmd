...
unzipped_eg <- data.table::fread("C:\\Users\\jason\\Google Drive\\GitHub\\git_projects\\google_ngrams_and_R\\data\\egs\\googlebooks-eng-1M-5gram-20090715-1.csv") 
set.seed(1999)
unzipped_eg %>%
  sample_n(5) %>%
  knitr::kable()
...
```{r echo=FALSE}
data.table::fread("C:\\Users\\jason\\Google Drive\\GitHub\\git_projects\\google_ngrams_and_R\\data\\egs\\eng-1M-5gram-20090715-1.csv") %>%
  sample_n(5) %>%
  knitr::kable()
```
...
```{r include=FALSE}
local_raw <- "C:\\Users\\jason\\Desktop\\raw"
```
...
```{r echo=FALSE}
setwd("C:\\Users\\jason\\Google Drive\\GitHub\\git_projects\\google_ngrams_and_R\\data\\egs")
